...
df = pd.read_csv("login_table.csv")
...
df0 = pd.read_csv("notif_table.csv")
...
#                                              "date","cost","loc"])
df3 = pd.read_csv("equi_table.csv")
...
df4 = pd.read_csv("damage_table.csv")
            ...
            html.H1('Equipment',
                ...
                html.Div([
                    ...
                    dcc.Input(id='equi-model', type='text',
                              style={'width':175}),
                    html.Br(),html.Br(),
                    dcc.Input(id='equi-date', type='text',
                              style={'width':175}),
                    html.Br(),html.Br(),
   ...
   if ctx.triggered:
       ...
       if eventid =="login-submit-button":
           ...
           if 1 not in login_mode:
               ...
               df2 = pd.read_csv("login_table.csv")
               name2 = list(df2['name'])
...
def notif_output(notif_submit_button,notif_save_button,notif_delete_button,
   ...
   if ctx.triggered:
       ...
       if eventid =="notif-submit-button":
           ...
           df = pd.read_csv("notif_table.csv")
           columns=[{"name": i, "id": i} for i in df.columns]
           data=df.to_dict("rows")
           name = df.name.unique().tolist()
           options=[{'label':n, 'value':n} for n in name]
           ...
           if 1 not in notif_mode:
               ...
               #df2 = querydatafromdatabase(sql2,[],["name"])
               df2 = pd.read_csv("notif_table.csv")
               name2 = list(df2['name'])
   ...
   if ctx.triggered:
       ...
       if eventid =="equi-submit-button":
           ...
           if 1 not in equi_mode:
               ...
               #df2 = querydatafromdatabase(sql2,[],["name"])
               df2 = pd.read_csv("equi_table.csv")
               name2 = list(df2['name'])
...
def damage_output(damage_submit_button,damage_save_button,damage_delete_button,damage_mode,
   ...
   if ctx.triggered:
       ...
       if eventid =="damage-submit-button":
           ...
           df = pd.read_csv("damage_table.csv")
           columns=[{"name": i, "id": i} for i in df.columns]
           data=df.to_dict("rows")
           name = df.name.unique().tolist()
           options=[{'label':n, 'value':n} for n in name]
           ...
           if 1 not in damage_mode:
               ...
               #df2 = querydatafromdatabase(sql2,[],["name"])
               df2 = pd.read_csv("damage_table.csv")
               name2 = list(df2['name'])
